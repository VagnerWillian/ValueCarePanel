...
import 'package:value_panel/app/modules/dashboard/ui/widgets/tiles/classification.tile.dart';
...
class _ClassificationsCardState extends State<ClassificationsCard> {
  ...
  @override
  void initState() {
    touchedIndex = widget.basicGroupChartDataEntity.values.indexOf(widget.basicGroupChartDataEntity.values.first);
    super.initState();
  }
