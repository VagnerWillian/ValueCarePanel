...
class ClassificationColumnGrid extends StatefulWidget {
  ...
  const ClassificationColumnGrid({Key? key, required this.value, this.classifications = const [], required this.updateMonitoringItem}) : super(key: key);
...
class _ClassificationColumnGridState extends State<ClassificationColumnGrid> {
  ...
  @override
  void initState() {
    selectedClassification = widget.classifications.singleWhere((c) => c.id==widget.value.classification);
    loading = false;
    super.initState();
  }
